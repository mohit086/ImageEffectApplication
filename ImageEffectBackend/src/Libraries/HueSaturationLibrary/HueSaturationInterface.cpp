...
JNIEXPORT jobjectArray JNICALL Java_com_iiitb_imageEffectApplication_libraryInterfaces_HueSaturationInterface_applyHueSaturation
  (JNIEnv * env, jclass jobj, jobjectArray image, jfloat hueValue, jfloat saturationValue) {
    ...
    applyHueSaturation(imageVector,hueValue,saturationValue); //function called here
